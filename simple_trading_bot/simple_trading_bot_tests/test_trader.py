...
class TestTrader(unittest.TestCase):
    ...
    def setUp(self):
        ...
        last_prices = {'GGAL': self._current_underlier_price, 'DLR': self._current_underlier_price}
        ...
        self._rofex_proxy_mock.bids.return_value = {
            'GGAL/MAY23': mdf.OrderbookLevel(115, 10), 'DLR/MAY23': mdf.OrderbookLevel(125, 10)}
        self._rofex_proxy_mock.asks.return_value = {
            'GGAL/MAY23': mdf.OrderbookLevel(120, 10), 'DLR/MAY23': mdf.OrderbookLevel(130, 10)}
        ...
        ggal_future = Future('GGAL/MAY23', self._maturity_date, 'GGAL', 100.)
        do_future = Future('DLR/MAY23', self._maturity_date, 'DLR', 1000.)
        ...
        self._instrument_expert_mock.rofex_instruments_by_ticker.return_value = {
            'GGAL/MAY23': ggal_future,
            'DLR/MAY23': do_future}
        self._instrument_expert_mock.maturities_of_tradeable_tickers.return_value = {
            'GGAL/MAY23': 'MAY23',
            'DLR/MAY23': 'MAY23'}
        self._instrument_expert_mock.tradeable_maturity_tags.return_value = ['MAY23']
    ...
    def test_trader_when_there_is_arb_opportunity(self):
        ...
        self.assertEqual(buy_order_args.kwargs['ticker'], 'GGAL/MAY23')
        ...
        self.assertEqual(sell_order_args.kwargs['ticker'], 'DLR/MAY23')
    ...
    def test_trader_when_there_is_no_arb_opportunity(self):
        self._rofex_proxy_mock.bids.return_value = {
            'GGAL/MAY23': mdf.OrderbookLevel(115, 10), 'DLR/MAY23': mdf.OrderbookLevel(120, 10)}
        self._rofex_proxy_mock.asks.return_value = {
            'GGAL/MAY23': mdf.OrderbookLevel(125, 10), 'DLR/MAY23': mdf.OrderbookLevel(130, 10)}
        self._ir_expert.update_rates()
        self._trader.evaluate_and_trade_each_maturiry()
